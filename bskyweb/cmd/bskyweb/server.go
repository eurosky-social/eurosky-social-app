...
func serve(cctx *cli.Context) error {
	...
	e.GET("/settings/network-services", server.WebGenericNoindex)
	e.GET("/settings/network-services/content-service", server.WebGenericNoindex)
	e.GET("/settings/network-services/transfer-app-data", server.WebGenericNoindex)
