...
describe('toShareUrl', () => {
  ...
  const outputs = [
    'https://bsky.app',
    `https://${host}/3jk7x4irgv52r`,
    `https://${host}/item/test/123`,
  ]
...
describe('createStarterPackGooglePlayUri', () => {
  const base =
    'https://play.google.com/store/apps/details?id=social.mu.app&referrer=utm_source%3Dbluesky%26utm_medium%3Dstarterpack%26utm_content%3Dstarterpack_'
